...
# Path of this script: C:\Users\admin\Documents\Projects_SEMES\RFMatcher\SAMBB_v1.01.007\Vitis\MatFW_001\MatFW_001_system\_ide\scripts\debugger_matfw_001-default.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source C:\Users\admin\Documents\Projects_SEMES\RFMatcher\SAMBB_v1.01.007\Vitis\MatFW_001\MatFW_001_system\_ide\scripts\debugger_matfw_001-default.tcl
# 
connect -url tcp:127.0.0.1:3121
targets -set -nocase -filter {name =~"APU*"}
rst -system
after 3000
targets -set -filter {jtag_cable_name =~ "Digilent Eclypse Z7 210393BE91A4A" && level==0 && jtag_device_ctx=="jsn-Eclypse Z7-210393BE91A4A-23727093-0"}
